...
import MovisePosterCast from "./MovisePosterCast";

const HollywoodMovise = ({ movises }) => {
  ...
  return (
    <>
      <h2 className={style.heading}>Hollywood Movies</h2>
...
export default HollywoodMovise;
